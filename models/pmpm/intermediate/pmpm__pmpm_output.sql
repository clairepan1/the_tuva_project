...
select
  ...
  cast(dd.service_category_1 as {{ dbt.type_string() }} ) as service_category_1,
  cast(dd.service_category_2 as {{ dbt.type_string() }} ) as service_category_2,
...
left join {{ ref('service_category') }} dd
