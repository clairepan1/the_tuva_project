...
, cast({{ date_part("year", "claim_end_date" ) }} as {{ dbt.type_string() }} ) || lpad(cast({{ date_part("month", "claim_end_date" ) }} as {{ dbt.type_string() }} ),2,'0') AS year_month
, claim_type
, paid_amount
...
, cast({{ date_part("year", "dispensing_date" ) }} as {{ dbt.type_string() }} ) || lpad(cast({{ date_part("month", "dispensing_date" ) }} as {{ dbt.type_string() }} ),2,'0') AS year_month
