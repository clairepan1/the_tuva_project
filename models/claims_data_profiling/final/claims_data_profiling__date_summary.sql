...
from {{ ref('claims_data_profiling__medical_claim_dates') }} a
full join {{ ref('claims_data_profiling__pharmacy_claim_dates') }} b
    on a.year_month = b.year_month
full join {{ ref('claims_data_profiling__member_months_count') }} c
...
, c.*
from {{ ref('claims_data_profiling__duplicate_dates') }} c
order by 1